...
const update = (e) => {
    ...
    for (const key of categories) {
        ...
        const percent = Math.round((category.stuPts.valueAsNumber / (category.maxPts.valueAsNumber || 1)) * 10000) / 100
...
const updateTotals = () => {
    const weightTotal = table.daily.weight.valueAsNumber + table.assessment.weight.valueAsNumber + table.major.weight.valueAsNumber;
